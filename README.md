...
[![Live Demo](https://img.shields.io/badge/Live_Demo-press--radar-3ddc6e?style=for-the-badge&logo=github)](https://namerami.github.io/PressRadar/PressRadar.html)
...
## 🔴 [→ Open Live Demo](https://namerami.github.io/PressRadar/PressRadar.html)
...
```bash
git clone https://github.com/NameRami/PressRadar.git
cd press-radar
...
Or just use the **[live demo](https://namerami.github.io/PressRadar/PressRadar.html)** — no cloning needed.
...
3. Your dashboard is live at `https://namerami.github.io/PressRadar`
